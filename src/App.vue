  ...
  <div class="container">
    ...
    <section class=" p-4">
      ...
      <div class=" flex flex-row gap-3  p-3 bg-slate-100">
        <div class="flex-col ">
          <tw-switch class="mt-6" :disabled="records.length===0" :color="accentColor" v-model="striped">Striped?</tw-switch>
        </div>
        <div class="flex-col">
          <tw-switch class="mt-6" :disabled="records.length===0" :color="accentColor" v-model="hover">Hover?</tw-switch>
        </div>
        <div class="flex-col">
          <tw-input form-name-and-id="productCount" type="number" v-model="numOfProducts">Number of product to create
          </tw-input>
        </div>
        <div class="flex-col">
        ...
        <div class="flex-col">
          <tw-button :disabled="records.length===0" @click="clearProducts" color="primary" outline class="mt-5">
    ...
    <section class="p-4">
      ...
      <div class="flex w-full justify-between py-2 ">
        <div>
          <tw-button :color="accentColor" :outline="buttonOutline" :corners="buttonSquare" size="sm"> Small button</tw-button>
        </div>
        <div>
          <tw-button :color="accentColor" :outline="buttonOutline" :corners="buttonSquare" size="md"> Medium button</tw-button>
        </div>
        <div>
          <tw-button :color="accentColor" :outline="buttonOutline" :corners="buttonSquare" size="lg"> large button</tw-button>
        </div>
        <div>
          <tw-button :color="accentColor" :outline="buttonOutline" :corners="buttonSquare" size="round"> Rounded button</tw-button>
        </div>
